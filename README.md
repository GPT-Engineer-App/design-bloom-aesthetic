...
**Project**: design-bloom-aesthetic 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I have this current UI, can you suggest how to make it prettier and more professional, I want to keep the color schemes etc. Use shadcdn for components
...
```sh
git clone https://github.com/GPT-Engineer-App/design-bloom-aesthetic.git
cd design-bloom-aesthetic
npm i
